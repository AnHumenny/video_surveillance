...
Поддерживает сканирование выбранного диапазона сети на наличие rtsp-потоков, детекцию движения, запись по запросу, отправку видеозахвата(движение) и/или скриншотов на указанный email или в ТГ-бота(aiogram).
